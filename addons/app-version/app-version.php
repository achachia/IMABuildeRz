...
$addons_settings = $db->getAddonsUsed("app-version");
...
if ($_GET['a'] === 'delete')
{
    $db->deleteAddOns('app-version', $current_page_target);
    header('Location: ./?p=addons&addons=app-version&' . time());
}

// TODO: POST
if (isset($_POST['save-app-version']))
{

    // save addons setting
    $addons = array();
    $addons['page-target'] = $current_page_target;
    $addons['page-title'] = trim($_POST['app-version']['page-title']);
    $addons['page-header-color'] = trim($_POST['app-version']['page-header-color']);
    $addons['page-content-background'] = trim($_POST['app-version']['page-content-background']);
    $db->saveAddOns('app-version', $addons);
    ...
    $newPage['modules']['angular'][$z]['class'] = 'AppVersion';
    $newPage['modules']['angular'][$z]['var'] = 'appVersion';
    $newPage['modules']['angular'][$z]['path'] = '@ionic-native/app-version/ngx';
    $newPage['modules']['angular'][$z]['native'] = '@ionic-native/app-version';
    $newPage['modules']['angular'][$z]['cordova'] = 'cordova-plugin-app-version';

    $z++;
    $newPage['modules']['angular'][$z]['class'] = 'Platform';
    $newPage['modules']['angular'][$z]['var'] = 'platform';
    $newPage['modules']['angular'][$z]['cordova'] = '';
    ...
    $newPage['content']['html'] .= "\t\t\t\t\t" . 'App Name' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '</ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '<ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t\t" . '<strong>{{ AppName }}</strong>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '</ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t" . '</ion-row>' . "\r\n";

    $newPage['content']['html'] .= "\t\t\t" . '<ion-row>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '<ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t\t" . 'Package Name' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '</ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '<ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t\t" . '<strong>{{ PackageName }}</strong>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '</ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t" . '</ion-row>' . "\r\n";

    $newPage['content']['html'] .= "\t\t\t" . '<ion-row>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '<ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t\t" . 'Version Code' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '</ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '<ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t\t" . '<strong>{{ VersionCode }}</strong>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '</ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t" . '</ion-row>' . "\r\n";

    $newPage['content']['html'] .= "\t\t\t" . '<ion-row>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '<ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t\t" . 'Version Number' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '</ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '<ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t\t" . '<strong>{{ VersionNumber }}</strong>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t\t" . '</ion-col>' . "\r\n";
    $newPage['content']['html'] .= "\t\t\t" . '</ion-row>' . "\r\n";
    ...
    $newPage['code']['constructor'] = "\t" . 'this.getAppVersion();';
    $newPage['code']['other'] = null;
    $newPage['code']['other'] .= "\t" . '' . "\r\n";
    $newPage['code']['other'] .= "\t" . '' . "\r\n";
    $newPage['code']['other'] .= "\t" . 'AppName: string = "?";' . "\r\n";
    $newPage['code']['other'] .= "\t" . 'PackageName: string = "?";' . "\r\n";
    $newPage['code']['other'] .= "\t" . 'VersionCode: string = "?";' . "\r\n";
    $newPage['code']['other'] .= "\t" . 'VersionNumber:string = "?";' . "\r\n";
    $newPage['code']['other'] .= "\t" . '' . "\r\n";
    $newPage['code']['other'] .= "\t" . '' . "\r\n";
    $newPage['code']['other'] .= "\t" . '/**' . "\r\n";
    $newPage['code']['other'] .= "\t" . '* getAppVersion()' . "\r\n";
    $newPage['code']['other'] .= "\t" . '**/' . "\r\n";
    $newPage['code']['other'] .= "\t" . 'getAppVersion(){' . "\r\n";
    $newPage['code']['other'] .= "\t\t" . 'if (this.platform.is("cordova")){' . "\r\n";
    $newPage['code']['other'] .= "\t" . '' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t" . 'this.appVersion.getAppName().then(appName=>{' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t\t" . 'this.AppName = appName;' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t" . '});' . "\r\n";
    $newPage['code']['other'] .= "\t" . '' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t" . 'this.appVersion.getPackageName().then(packageName=>{' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t\t" . 'this.PackageName = packageName;' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t" . '});' . "\r\n";
    $newPage['code']['other'] .= "\t" . '' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t" . 'this.appVersion.getVersionCode().then(versionCode=>{' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t\t" . 'this.VersionCode = versionCode.toString();' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t" . '});' . "\r\n";
    $newPage['code']['other'] .= "\t" . '' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t" . 'this.appVersion.getVersionNumber().then(versionNumber=>{' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t\t" . 'this.VersionNumber = versionNumber.toString();' . "\r\n";
    $newPage['code']['other'] .= "\t\t\t" . '});' . "\r\n";
    $newPage['code']['other'] .= "\t" . '' . "\r\n";
    ...
    $db->current();
    rebuild();
    header('Location: ./?p=addons&addons=app-version&page-target=' . $current_page_target . '&' . time());
...
{
    $current_setting = $db->getAddOns('app-version', $current_page_target);
}
...
$content .= '<select id="page-target" name="app-version[page-target]" class="form-control" >';
...
$content .= '<input  id="page-title" type="text" name="app-version[page-title]" class="form-control" placeholder="My Pages"  value="' . $current_setting['page-title'] . '" required ' . $disabled . ' />';
...
$content .= '<select name="app-version[page-header-color]" class="form-control select-color" data-color="' . $current_setting['page-header-color'] . '">';
...
$content .= '<input id="page-content-background" type="text" name="app-version[page-content-background]" class="form-control" placeholder="assets/images/bg-01.png"  value="' . $current_setting['page-content-background'] . '"  ' . $disabled . ' required />';
...
$content .= '<input name="save-app-version" type="submit" class="btn bg-purple btn-flat pull-left" value="' . __e('Save Changes') . '" ' . $disabled . '/>';
$content .= '</div>';
...
if (count($addons_settings) >= 1)
{
    ...
    foreach ($addons_settings as $pageList)
    {
        ...
        $content .= '<td>';
        $content .= '<a href="./?p=addons&amp;addons=app-version&amp;page-target=' . $pageList['page-target'] . '&amp;a=edit#!_" class="btn btn-xs btn-flat btn-success"><i class="fa fa-pencil-square-o"></i> ' . __e('Edit') . '</a>&nbsp;';
        $content .= '<a href="#!_./?p=addons&amp;addons=app-version&amp;page-target=' . $pageList['page-target'] . '&amp;a=delete#!_" data-toggle="modal" data-target="#trash-dialog-' . $no . '" class="btn btn-xs btn-flat btn-danger"><i class="fa fa-trash"></i> ' . __e('Delete') . '</a>';
        $content .= '</td>';
        $content .= '</tr>';
        ...
        $modal_dialog .= '<a href="./?p=addons&amp;addons=app-version&amp;page-target=' . $pageList['page-target'] . '&amp;a=delete" class="btn btn-danger">' . __e('Yes') . '</a>&nbsp;';
...
// TODO: JS
$page_js .= '$("#page-target").on("change",function(){return window.location="?p=addons&addons=app-version&page-target="+$("#page-target").val(),!1});';
